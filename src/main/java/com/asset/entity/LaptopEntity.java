...
public class LaptopEntity {
	...
	public LaptopEntity(int gGID, String category, String asset_Type, String serialNumber, String assetName,
	...
	public String toString() {
		return "LaptopEntity [gGID=" + gGID + ", category=" + category + ", asset_Type=" + asset_Type
