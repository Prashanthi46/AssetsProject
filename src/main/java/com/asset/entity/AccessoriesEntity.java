...
import javax.validation.constraints.NotNull;
	...
	public class AccessoriesEntity {
		...
		public AccessoriesEntity(int gGID,String category, String assetType, String serialNumber, String assetName,
		...
		public String toString() {
			return "AccessoriesEntity [gGID=" + gGID + ", category=" + category + ", assetType=" + assetType
					...
					+ ", surrender_Release_Date=" + surrender_Release_Date + ", Location=" + Location + ", status=" + status
					+ ", comments=" + comments + ", procurement_Reference=" + procurement_Reference + "]";
		}
